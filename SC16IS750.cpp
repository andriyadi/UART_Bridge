...
size_t SC16IS750::write(const uint8_t *buffer, size_t size) {
    size_t n = 0;
    while(size--) {
        n += write(*buffer++);
    }
...
size_t SC16IS750::printf(const char *format, ...) {
    va_list arg;
    va_start(arg, format);
    char temp[64];
    char* buffer = temp;
...
size_t SC16IS750::print(const __FlashStringHelper *ifsh) {
...
size_t SC16IS750::print(const String &s) {
    return write(s.c_str(), s.length());
}

size_t SC16IS750::print(const char str[]) {
    return write(str);
}

size_t SC16IS750::print(char c) {
    return write(c);
}

size_t SC16IS750::print(unsigned char b, int base) {
    return print((unsigned long) b, base);
}

size_t SC16IS750::print(int n, int base) {
    return print((long) n, base);
}

size_t SC16IS750::print(unsigned int n, int base) {
    return print((unsigned long) n, base);
}

size_t SC16IS750::print(long n, int base) {
    if(base == 0) {
        return write(n);
    } else if(base == 10) {
        if(n < 0) {
...
size_t SC16IS750::print(unsigned long n, int base) {
    if(base == 0)
        return write(n);
    else
        return printNumber(n, base);
...
size_t SC16IS750::print(double n, int digits) {
    return printFloat(n, digits);
}

size_t SC16IS750::print(const Printable& x) {
    return x.printTo(*this);
}

size_t SC16IS750::println(const __FlashStringHelper *ifsh) {
    size_t n = print(ifsh);
    n += println();
    return n;
}

size_t SC16IS750::println(void) {
    return print("\r\n");
}

size_t SC16IS750::println(const String &s) {
    size_t n = print(s);
    n += println();
    return n;
}

size_t SC16IS750::println(const char c[]) {
    size_t n = print(c);
    n += println();
    return n;
}

size_t SC16IS750::println(unsigned char b, int base) {
    size_t n = print(b, base);
    n += println();
    return n;
}

size_t SC16IS750::println(int num, int base) {
    size_t n = print(num, base);
    n += println();
    return n;
}

size_t SC16IS750::println(unsigned int num, int base) {
    size_t n = print(num, base);
    n += println();
    return n;
}

size_t SC16IS750::println(long num, int base) {
    size_t n = print(num, base);
    n += println();
    return n;
}

size_t SC16IS750::println(unsigned long num, int base) {
    size_t n = print(num, base);
    n += println();
    return n;
}

size_t SC16IS750::println(double num, int digits) {
    size_t n = print(num, digits);
    n += println();
    return n;
}

size_t SC16IS750::println(const Printable& x) {
    size_t n = print(x);
    n += println();
    return n;
}

size_t SC16IS750::printNumber(unsigned long n, uint8_t base) {
...
size_t SC16IS750::printFloat(double number, uint8_t digits) {
	size_t n = 0;
